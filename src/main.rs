...
fn eq_str(id:i64) -> String{
    ...
    match id {
        ...
        10=> eq = "y=\\left\\lceil 400 \\times \\left( (\\frac{1}{2}+\\frac{x}{4} \\right)\\sqrt{1-x}+\\frac{1}{2}) \\right\\rceil \\times 10",
        11=> eq = "y=\\left\\lceil 100 \\times \\left( [\\frac{1}{2}+\\frac{x}{4} \\right)\\sqrt{1-x}+\\frac{1}{2}) \\right\\rceil \\times 10",
        12=> eq = "y=\\left\\lceil 40 \\times \\left( [\\frac{1}{2}+\\frac{x}{4} \\right)\\sqrt{1-x}+\\frac{1}{2}) \\right\\rceil \\times 10",
